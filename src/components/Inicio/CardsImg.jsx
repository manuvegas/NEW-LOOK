  ...
  return (
    <div className="flex justify-center opacity-100 ">
      <Link to={`/CardMap/${titulo}`} className="relative overflow-hidden">
        <div className="transition-transform duration-500 ease-in-out transform-gpu hover:scale-110 ">
          <img src={img} alt={titulo} className="w-80 xs:w-[600px] sm:w-[325px] h-96 object-cover" />
