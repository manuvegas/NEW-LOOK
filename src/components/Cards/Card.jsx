...
const Card = ({ precio, titulo, img, id, className }) => {
  return (
    <div>
      <div
        className={` bg-[#060606] border-transparent overflow-hidden text-center  relative  rounded-none bg-gradient-to-br shadow-2xl ${className}`}
      >
